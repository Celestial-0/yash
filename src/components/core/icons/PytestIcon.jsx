...
const PytestIcon = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    />
    <path fill="#009fe3" d="M32.047 24.32H44.37v2.844H32.047zm0 0" />
    <path fill="#c7d302" d="M48.168 24.32h12.324v2.844H48.168zm0 0" />
    <path fill="#f07e16" d="M64.07 24.32h12.328v2.844H64.07zm0 0" />
    <path
      fill="#df2815"
      d="M79.91 24.32h12.324v2.844H79.91zm0 15.22h12.324v20.835H79.91zm0 0"
    />
    <path fill="#f07e16" d="M64.07 39.54h12.352v33.847H64.07zm0 0" />
