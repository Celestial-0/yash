    ...
    return (
        <Flex className={ 'z-50 bottom-0 fixed w-full pointer-events-none' }>
            <Dock direction={ 'middle' } className={ 'rounded-full bg-[--color-panel] !gap-0 mb-8 pointer-events-auto' }>
                ...
                <DockIcon>
                    <NavigationLink href={ 'https://github.com/Celestial-0' } label={ 'GitHub' }>
                        <FaGithub size={ '1.10rem' } />
                    </NavigationLink>
                </DockIcon>
                <DockIcon>
                    <NavigationLink href={ 'https://leetcode.com/u/Celestial-0/' } label={ 'LeetCode' }>
                        <SiLeetcode size={ '1.10rem' } />
                    </NavigationLink>
                </DockIcon>
                <DockIcon>
                    <NavigationLink href={ 'https://www.linkedin.com/in/celestial0/' } label={ 'LinkedIn' }>
